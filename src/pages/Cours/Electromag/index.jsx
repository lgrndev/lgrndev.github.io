...
function ElectromagCours() {
    return (
        <div className="text-white flex flex-col justify-center items-center">
          <div className='w-1/3 flex flex-col'>
            <div className='text-4xl text-center poppins-bold'>Electromagnétostatique</div>
            ...
            <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <div style={{ height: '750px'}}>
                    <Viewer fileUrl="/cours/electromag/electromagC1.pdf" />
                </div>
            </Worker>
            <div className='text-xl text-center poppins-bold mb-8 mt-10'>Chapitre 2</div>
            <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <div style={{ height: '750px'}}>
                    <Viewer fileUrl="/cours/electromag/electromagC2.pdf" />
                </div>
            </Worker>
            <div className='text-xl text-center poppins-bold mb-8 mt-10'>Chapitre 3</div>
            <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <div style={{ height: '750px'}}>
                    <Viewer fileUrl="/cours/electromag/electromagC3.pdf" />
                </div>
            </Worker>
            </div>
        </div>
...
export default ElectromagCours;
